...
exports.onExchangeCreatedNotifyTarget = (0, firestore_1.onDocumentCreated)("exchanges/{exchangeId}", async (event) => {
    ...
    const ownerName = pickString(data["ownerName"]) || "el publicador";
    ...
    const targetNotificationId = await createNotification({
        targetUid,
    ...
    logger.info("Notificaciones iniciales de intercambio creadas", {
        exchangeId,
        targetUid,
        actorUid,
